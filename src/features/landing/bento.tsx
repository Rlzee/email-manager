                ...
                <div>
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-2xl font-bold">
                      All your emails, one place
                    </h3>
                  </div>
                  <p className="text-muted-foreground text-lg mb-8">
                    Connect Gmail, iCloud, Outlook and more. Manage all your
                    email accounts from a single, intuitive interface.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {["Gmail", "iCloud", "Outlook", "Yahoo"].map((provider) => (
                      <Badge
                        key={provider}
                        className="text-sm text-secondary py-2 px-4 rounded-xl"
                      >
                        {provider}
                      </Badge>
                    ))}
            ...
            <div className="bg-secondary border md:rounded-tr-xl md:rounded-bl-none p-8 flex flex-col justify-between min-h-[400px]">
              <AnimatedGroup preset="slide" inView inViewMargin="-200px">
                <div>
                  ...
                  <p className="text-muted-foreground text-lg mb-8">
                    Automatically sort your emails, detect spam and organize
                    your inbox with AI.
                  </p>
