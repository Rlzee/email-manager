        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 py-16 md:py-32 items-center">
            <div>
                ...
                <p className="text-muted-foreground mb-6 text-base md:text-lg">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Delectus, nostrum autem. Est incidunt possimus, expedita modi provident quis delectus atque, consequatur illum quaerat nihil hic optio magnam eius ratione facere tempore omnis quibusdam maiores sunt earum temporibus molestias! Veritatis, molestiae temporibus delectus assumenda facere deserunt. Aut natus et hic magnam, quas, sunt quasi praesentium provident deleniti impedit ducimus velit aliquam?
                </p>
            </div>
